...
# Se usan nombres vacíos para no mostrar datos ficticios en el portal si la BD falla.
# Los datos reales se cargan desde la tabla `moviles` vía obtener_detalles_moviles().
